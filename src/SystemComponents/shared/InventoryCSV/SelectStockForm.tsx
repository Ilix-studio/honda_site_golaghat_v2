// src/SystemComponents/shared/StockConcept/SelectStockForm.tsx
  ...
  const STOCK_OPTIONS = [
    {
      ...
      route: `${prefix}/forms/stock-concept-csv`,
    ...
    },
    {
      ...
      icon: Database,
      route: `${prefix}/forms/stock-concept`,
