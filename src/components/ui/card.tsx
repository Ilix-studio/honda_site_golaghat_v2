...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-(--card-spacing) rounded-xl border py-(--card-spacing) shadow-sm [--card-spacing:--spacing(6)] data-[size=sm]:[--card-spacing:--spacing(4)]",
        className
      )}
      {...props}
    />
