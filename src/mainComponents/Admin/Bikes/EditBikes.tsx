...
const EditBikes = () => {
  ...
  const onSubmit = async (data: BikeFormData) => {
    ...
    try {
      await updateBike({ id, data }).unwrap();
      dispatch(
        addNotification({
          type: "success",
    ...
    return (
      <div className='min-h-screen bg-gray-50 flex items-center justify-center'>
        <div className='flex items-center gap-2'>
          ...
          <span>Loading motorcycle data...</span>
        </div>
      </div>
    );
  }
        ...
        <div className='container max-w-4xl px-4 py-8'>
          <div className='text-center'>
            ...
            <p className='text-muted-foreground mb-4'>
              The motorcycle you're trying to edit doesn't exist or has been
              removed.
            </p>
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      <div className='container max-w-4xl px-4 py-8'>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Edit Motorcycle - {bike.modelName}</CardTitle>
          </CardHeader>
          <CardContent>
