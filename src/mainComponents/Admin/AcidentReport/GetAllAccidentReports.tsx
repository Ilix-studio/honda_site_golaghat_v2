...
const SELECT_CLS =
  "w-full h-9 rounded-md border border-gray-200 bg-white px-3 py-1.5 text-sm text-gray-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-900/20 focus:border-gray-400 cursor-pointer";
          ...
          <CardContent className='p-4'>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3'>
              ...
              >
                ...
                <option value='true'>Insurance Available</option>
                      ...
                      filtered.map((report) => (
                        ...
                        >
                          ...
                          <TableCell>
                            <Badge
                              variant='outline'
                              className={`text-xs ${STATUS_BADGE[report.status].className}`}
                            >
