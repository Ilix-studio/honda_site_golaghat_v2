...
> = {
  "/developer/dashboard": {
    ...
    subtitle: "Maintenance Service Requests",
  },
};
...
const DeveloperHeader = () => {
  ...
  const currentRoute = routeConfig[location.pathname] || {
    title: "Developer",
    subtitle: "Project Maintenance",
  };

  useEffect(() => {
    if (!isAuthenticated) navigate("/developer/login");
        ...
        <div className='flex items-center justify-between h-14'>
          <div className='flex items-center gap-3'>
            ...
            >
              ...
              <span className='text-sm font-black text-white tracking-tight hidden sm:block'>
                Tsangpool <span className='text-violet-400'>Developer</span>
              </span>
            </Link>
          ...
          <div className='flex items-center gap-2'>
            ...
            <button
              ...
              className='flex items-center gap-1.5 h-8 px-3 rounded-xl bg-violet-600/10 hover:bg-violet-600/20 border border-violet-600/20 hover:border-violet-600/40 text-violet-300 hover:text-violet-200 text-xs font-semibold transition-all disabled:opacity-50'
            >
