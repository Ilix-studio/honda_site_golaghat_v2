    ...
    <div className='max-w-4xl mx-auto p-4 md:p-6 lg:p-8 bg-white dark:bg-card rounded-lg'>
        ...
        <div className='flex-1 w-full max-w-md'>
          {[
            ...
            <div key={item.stars} className='flex items-center gap-3 mb-1.5'>
              <span className='text-sm font-medium text-gray-700 dark:text-gray-300 w-3'>
                {item.stars}
              </span>
      ...
      <div className='space-y-6'>
        ...
        <div className='mb-6'>
          <div className='flex items-start justify-between mb-3'>
            <div className='flex gap-3'>
              <div className='relative w-10 h-10 rounded-full overflow-hidden bg-green-800 flex items-center justify-center shrink-0'>
                <img
                  src='https://api.dicebear.com/7.x/avataaars/svg?seed=Nilutpol'
                  alt='avatar'
              ...
              <div>
                ...
                <p className='text-sm text-gray-500 dark:text-gray-400'>
                  Local Guide · 3 reviews · 69 photos
                </p>
              </div>
            </div>
          ...
          <div className='flex items-center gap-2 mb-3'>
            <div className='flex items-center'>
              {[1, 2, 3, 4, 5].map((i) => (
                <Star
                  key={i}
                  className='w-[14px] h-[14px] fill-[#fbbc04] text-[#fbbc04]'
                />
              ))}
            </div>
          ...
          <p className='text-[15px] text-gray-800 dark:text-gray-200 mb-2 font-medium'>
            Exceptional Service and Friendly Staff!
          </p>
          <p className='text-[15px] text-gray-800 dark:text-gray-200 mb-4'>
            I had an absolutely wonderful experience purchasing my new Honda.
            The team was incredibly helpful, transparent, and made the entire
            process completely hassle-free from start to finish...{" "}
          ...
          <div className='flex items-center gap-4 mb-4'>
            ...
            <div className='flex items-center gap-1.5'>
              <button className='flex items-center justify-center p-1.5 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-colors'>
                <Heart
                  className='w-[18px] h-[18px] fill-red-500 text-red-500'
                  strokeWidth={2}
                />
              </button>
          ...
          <div className='flex gap-3 mt-4 ml-0 pl-4 border-l-[3px] border-gray-200 dark:border-gray-700 py-1'>
            ...
            <div>
              <div className='flex items-center gap-2 mb-1'>
                <h5 className='font-semibold text-gray-900 dark:text-gray-100 text-[14px]'>
                  Tsangpool Honda (owner)
                </h5>
                <span className='text-sm text-gray-500 dark:text-gray-400'>
                  4 months ago
                </span>
              ...
              <p className='text-[14px] text-gray-800 dark:text-gray-200'>
                Thank you so much for the glowing review, Nilutpol! We are
                thrilled to hear that you had a great experience with our team.
                Wishing you many happy miles on your new Ride!
              </p>
            </div>
          </div>
        </div>
