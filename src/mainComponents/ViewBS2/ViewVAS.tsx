...
const ViewVAS = () => {
  ...
  const handleEdit = (vasId: string) => {
    navigate(`/manager/edit/vas/${vasId}`); // <-- Changed from ?id= to /
  };
            ...
            >
              <div className='p-6'>
                ...
                <div className='mt-5 pt-4 border-t border-gray-100'>
                  <button
                    onClick={() => handleEdit(vas._id)}
                    className='w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-50 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200 border border-gray-200 transition-colors'
                  >
