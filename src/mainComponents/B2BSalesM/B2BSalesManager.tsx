    ...
    <div className='max-w-6xl mx-auto p-4 sm:p-6 space-y-6'>
      <div className='flex items-center justify-between flex-wrap gap-3'>
        <div className='flex items-center gap-3'>
          ...
          <div>
            <h1 className='text-xl font-bold text-gray-900'>B2B Sales (Challans)</h1>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className='text-right'>Payable Price</TableHead>
                ...
                <TableBody>
                  {sales.map((sale) => (
                    <TableRow key={sale._id}>
                      <TableCell className='font-mono font-medium'>{sale.challanNo}</TableCell>
                      {isSuperAdmin && <TableCell>{branchName(sale.branchId)}</TableCell>}
                      <TableCell>{sale.to}</TableCell>
                      <TableCell>{formatDate(sale.date)}</TableCell>
                      <TableCell className='text-right'>{inr(sale.totalPrice)}</TableCell>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  <span className='font-mono'>{sale.challanNo}</span> to{" "}
                                  {sale.to} and releases its stock item(s) back to
                                  Available.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
